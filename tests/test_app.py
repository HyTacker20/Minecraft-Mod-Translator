...
class TestCommandLine:
    ...
    def test_parser_ai_flag(self):
        parser = build_argument_parser()
        args = parser.parse_args(["-s", "en_US", "--ai"])
...
class TestProgressReporter:
    ...
    def test_multiple_subscribers(self):
        ...
        results = []
        reporter = ProgressReporter()
        reporter.subscribe(lambda event, **kwargs: results.append(1))
        reporter.subscribe(lambda event, **kwargs: results.append(2))
